  ...
  return (
    <section className="align-middle">
      ...
      <div className="md:flex md:gap-6">
        ...
        <div className="flex justify-center items-end md:justify-end md:min-w-[18%] md:items-center">
          <Link
          ...
          >
            ...
            <span className="absolute w-full text-center top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 text-xs font-bold text-blue-300 group-hover:text-white transition ease-in-out duration-500">
              VIEW ALL
            </span>
          </Link>
        </div>
